...
{
    public partial class StandartKullaniciKayitOL : Form
    {
        public static List<Kullanici> kullaniciListesi { get; set; } = new List<Kullanici>();
        public StandartKullaniciKayitOL()
        {
            InitializeComponent();
        }
        ...
        private void Btn_Kayitol_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Kayıt Olma İşlemi Başarılı.Ödenecek Tutar 100TL, Lütfen Giriş Yapınız");
            this.Hide();
        }
    }
}
